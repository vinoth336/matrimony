...
class CreateTableMemberHoroscopeRequest extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('member_horoscope_request', function (Blueprint $table) {
            $table->uuid('id');
    ...
    {
        Schema::dropIfExists('member_horoscope_request');
    }
}
