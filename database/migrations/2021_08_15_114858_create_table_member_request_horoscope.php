...
class CreateTableMemberRequestHoroscope extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('member_request_horoscope', function (Blueprint $table) {
            $table->uuid('id');
    ...
    {
        Schema::dropIfExists('member_request_horoscope');
    }
}
