                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 profile_container scrollit" style="min-height:100vh;">
                        <div class="row" style="margin-top: 2rem">
                            <div class="col-12">
                                <a class="btn float-left btn-success @if($selected_tab == 'profile_photo_request_received') btn-success @endif" href="{{ route('member.profile_photo_request_received') }}">
                                    <i class="icon-camera"></i>&nbsp;Request
                                </a>
                                <a class="btn float-right @if($selected_tab == 'profile_photo_request_sent') btn-success @endif" href="{{ route('member.profile_photo_request_sent') }}">
